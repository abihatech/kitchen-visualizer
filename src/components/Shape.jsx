...
const kitchenShapes = [
    { name: 'L-SHAPE', image: l_shape },
    { name: 'U-SHAPE', image: u_shape },
    { name: 'I-SHAPE', image: i_shape }
];

const Shape = ({ setCurrentStep ,setSelectedShape}) => {
    return (
            ...
            <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
                <div className="bg-[#00000090]  p-8 md:p-12 text-white text-center max-w-4xl w-full">
                    ...
                    <div className="flex justify-center mt-8">
                        <button className="p-1 md:p-2 rounded-full border-2  transition-colors duration-200" onClick={() => setCurrentStep('space')}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
